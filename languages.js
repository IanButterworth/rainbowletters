  ...
  const data = {
    es: {
      ...
      ui: {
        ...
        language: 'Idioma',
        modes: { free: 'Juego libre', hunt: 'Caza de palabras', quiet: 'Caza de palabras sin pistas' },
    ...
    en: {
      ...
      ui: {
        ...
        language: 'Language',
        modes: { free: 'Free play', hunt: 'Word hunt', quiet: 'Word hunt, no hints' },
        find: 'Find {letter}',
    ...
    fr: {
      ...
      ui: {
        ...
        language: 'Langue',
        modes: { free: 'Jeu libre', hunt: 'Chasse aux mots', quiet: 'Chasse aux mots sans indices' },
    ...
    de: {
      ...
      ui: {
        ...
        fullscreen: 'Vollbild',
        language: 'Sprache',
        modes: { free: 'Freies Spiel', hunt: 'Wörterjagd', quiet: 'Wörterjagd ohne Hilfe' },
    ...
    pt: {
      ...
      ui: {
        ...
        language: 'Idioma',
        modes: { free: 'Jogo livre', hunt: 'Caça às palavras', quiet: 'Caça às palavras sem pistas' },
    ...
    it: {
      ...
      ui: {
        ...
        language: 'Lingua',
        modes: { free: 'Gioco libero', hunt: 'Caccia alle parole', quiet: 'Caccia alle parole senza aiuti' },
    ...
    sv: {
      ...
      ui: {
        ...
        fullscreen: 'Helskärm',
        language: 'Språk',
        modes: { free: 'Fritt spel', hunt: 'Ordjakt', quiet: 'Ordjakt utan ledtrådar' },
        find: 'Hitta {letter}',
